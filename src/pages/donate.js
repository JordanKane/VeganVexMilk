...
const donate = () => {
  return (
    <Layout>
      ...
      <section class="text-gray-600 body-font grid gap-6 place-items-center min-h-screen mt-[20rem] bg-dsc-atraks">
        <div className="rounded bg-gray-50">
          ...
          <iframe
            ...
            scrolling="no"
            seamless="seamless"
            src="https://donorbox.org/embed/vegan-vex-milk-raid-carries?only_donor_wall=true"
            className="w-full max-w-[500px] min-w-[310px] max-h-[300px] min-h-[300px]"
          ></iframe>
